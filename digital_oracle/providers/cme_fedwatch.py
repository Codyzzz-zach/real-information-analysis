...
_KALSHI_FALLBACK_HELP = (
    "CME FedWatch endpoint is blocking non-browser requests (Akamai anti-scraping). "
    "Use Kalshi KXFED series as a substitute for FOMC rate probabilities:\n"
    "  kalshi = KalshiProvider()\n"
    "  markets = kalshi.list_markets(KalshiMarketQuery(series_ticker=\"KXFED\", limit=20))\n"
    "Or use FRED FEDFUNDS series to get the effective federal funds rate trend."
)
